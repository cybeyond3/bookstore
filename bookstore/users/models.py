...
from db.base_model import BaseModel  # 导包
from hash.base_hash import get_hash  # 导包
...
class AddressManager(models.Manager):
	...
	def get_default_address(self, passport_id):
		'''查询指定用户的默认收货地址'''
		try:
			addr = self.get(passport_id=passport_id, is_delete=False)
...
class Address(BaseModel):
	...
	class Meta:
		...
		verbose_name_plural = verbose_name = '收件地址信息'
